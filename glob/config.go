...
var (
	...
	Opt_bound_flag        = flag.Int64("opt-bound", math.MaxInt64, "Initial bound for optimization function <= given value. Negative values allowed. Default is largest upper bound.")
	...
	First_aux_id_flag     = flag.Int("aux-id", 1, "Set initial variable counter for auxiliary Ids.")
