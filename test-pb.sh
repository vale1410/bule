...
for x in instances/*/*; do ./bule pb -f $x --cat 2 --solver cmsat | grep instance; done | column -s ';' -t 
echo 
echo BULE with cat 2 and cmsat
for x in instances/*/*; do ./bule pb -f $x --cat 1 --solver cmsat | grep instance; done | column -s ';' -t 
